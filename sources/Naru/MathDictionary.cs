...
namespace Naru {
  ...
  //######################################################################################
  //
  // Dictionary to Keep Constants, Variables, Functions
  //
  // @Author : Farore
  // @Date   : 2014
  ...
  public class MathDictionary {
    ...
    private Dictionary<string, ValueBase> variables     = new Dictionary<string, ValueBase>();
    private Dictionary<string, ValueBase> constants     = new Dictionary<string, ValueBase>();
    private List<FunctionBase>            functions     = new List<FunctionBase>();
    private Dictionary<string, string>    functionTexts = new Dictionary<string, string>();
    private Dictionary<string, string>    constantTexts = new Dictionary<string, string>();
